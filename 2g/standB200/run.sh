...
hlr="osmo-hlr"
stp="osmo-stp"
sgsn="osmo-sgsn -c osmo-sgsn.cfg"
ggsn="osmo-ggsn -c osmo-ggsn.cfg"
pcu="osmo-pcu -c osmo-pcu.cfg"
#bsc="osmo-bsc"
...
xterm -e osmo-trx-uhd -c osmo-trx.cfg &
sleep 2
xterm -e osmo-bts-trx -c bts_2610.cfg &
sleep 2
xterm -e osmo-bsc -c bsc_2610.cfg  &
sleep 2
